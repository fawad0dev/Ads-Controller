...
namespace CustomAds.GMA {
    ...
    /// </summary>
    public class GMAInterstitialAd : MonoBehaviour, IInterstitialAd {
        ...
        public void Load(Action<AdResult> onComplete) {
            ...
            InterstitialAd.Load(AdUnitId, adRequest, HandleAdLoaded);
        }
        ...
        public void LogResponseInfo() {
            if (_interstitialAd != null) {
                var info = _interstitialAd.GetResponseInfo();
